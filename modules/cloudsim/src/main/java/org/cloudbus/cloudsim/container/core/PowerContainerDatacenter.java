...
public class PowerContainerDatacenter extends ContainerDatacenter {
    ...
    protected void updateCloudletProcessing() {
        System.out.println("未使用-updateCloudletProcessing");
...
//        Log.printLine("Power data center is Updating CloudetProcessingWithoutSchedulingFutureEventsForce");
        ...
        System.out.println("\n\nVMmigration-3-PowerContainerDatacenter.updateCloudetProcessingWithoutSchedulingFutureEventsForce");
        Log.printLine("--------------------------------------------------------------\n\n");
        ...
        for (PowerContainerHost host : this.<PowerContainerHost>getHostList()) {
            ...
            System.out.println("VMmigration-3-1-输出HostUtilization");
            Log.formatLine(
        ...
        if (timeDiff > 0) {
            ...
            System.out.println("Energy-1-PowerContainerDatacenter.updateCloudetProcessingWithoutSchedulingFutureEventsForce");
            ...
            for (PowerContainerHost host : this.<PowerContainerHost>getHostList()){
                ...
                double timeFrameHostEnergy = host.getEnergyLinearInterpolation(
                        ...
                        utilizationOfCpu,
                        timeDiff);
                //timeFrameDatacenterEnergy:累加的能耗
            ...
            for (double i:getDatacenterEnergyList()) {
                System.out.print(i+"  ");
            }
            System.out.println();
        ...
        System.out.println("DatacenterEnergy:"+getPower());
        ...
        for (PowerContainerHost host : this.<PowerContainerHost>getHostList()) {
            for (ContainerVm vm : host.getCompletedVms()) {
                System.out.println("VMmigration-3-3调用deallocateHostForVm");
        ...
        Log.print(String.format("\nThe number of Containers Up and running is %d", numberOfContainers));
        Log.printLine();
    ...
    protected void processVmMigrate(SimEvent ev, boolean ack) {
        System.out.println("VMmigration-8-PowerContainerDatacenter.processVmMigrate");
