...
public abstract class ContainerVmScheduler {
    ...
    public List<Double> getAllocatedMipsForContainerVm(ContainerVm vm) {
        //System.out.println("VMallocation-5A-3-ContainerVmScheduler.getAllocatedMipsForContainerVm");
    ...
    public double getTotalAllocatedMipsForContainerVm(ContainerVm vm) {
        //System.out.println("VMallocation-5A-2-ContainerVmScheduler.getTotalAllocatedMipsForContainerVm");
        double allocated = 0;
    ...
    public double getPeCapacity() {
        System.out.println("HostPE-4-ContainerVmScheduler.getPeCapacity");
        if (getPeList() == null) {
            Log.printLine("Pe list is empty");
            return 0;
        }
