...
public abstract class PowerModelSpecPower implements PowerModel {
	...
	public double getPower(double utilization) throws IllegalArgumentException {
		//System.out.println("Energy-4-PowerModelSpecPower.getPower");
		if (utilization < 0 || utilization > 1) {
			throw new IllegalArgumentException("Utilization value must be between 0 and 1");
		}
		/**
		 * {@link org.cloudbus.cloudsim.power.models.PowerModelSpecPowerHpProLiantMl110G4Xeon3040}
		 * {@link PowerModelSpecPowerHpProLiantMl110G4Xeon3040#getPowerData}
		 *
		 * @see org.cloudbus.cloudsim.power.models.PowerModelSpecPowerHpProLiantMl110G4Xeon3040
		 * @see PowerModelSpecPowerHpProLiantMl110G4Xeon3040
		 * @see PowerModelSpecPowerHpProLiantMl110G4Xeon3040#getPowerData
		 */
		...
		//System.out.println("Energy-4-1-调用PowerModelSpecPowerHpProLiantMl110G4Xeon3040.getPowerData");
		/**
		 * @see org.cloudbus.cloudsim.power.models.PowerModelSpecPowerHpProLiantMl110G4Xeon3040#getPowerData
		 */
		double power1 = getPowerData(utilization1);
		double power2 = getPowerData(utilization2);
		double delta = (power2 - power1) / 10;
		//功率按照两点之间是直线的方式计算，此处公式没错
