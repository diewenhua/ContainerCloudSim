...
//    added from the power Vm
    ...
    public double getTotalUtilizationOfCpu(double time) {
        ...
        System.out.println("Containerallocation-2-0-2-Container.getTotalUtilizationOfCpu");
        /**
         * @see org.cloudbus.cloudsim.container.schedulers.ContainerCloudletSchedulerDynamicWorkload#getTotalUtilizationOfCpu
         */
    ...
    public double getTotalUtilizationOfCpuMips(double time) {
         ...
         * @see org.cloudbus.cloudsim.container.schedulers.ContainerCloudletSchedulerDynamicWorkload#getTotalUtilizationOfCpu
         */
        //System.out.println("Containerallocation-2-0-1-Container.getTotalUtilizationOfCpu");
        //System.out.println("getTotalUtilizationOfCpu(time):"+getTotalUtilizationOfCpu(time)+" "+getMips());
...
//
    ...
    public List<Double> getCurrentRequestedMips() {
        //System.out.println("VMallocation-5-3-2-Container.getCurrentRequestedMips");
        if (isBeingInstantiated()) {
            //System.out.println("VMallocation-5-3-2-A");
            List<Double> currentRequestedMips = new ArrayList<>();
            //getNumberOfPes():Container的PE数，都为1
        ...
        /**
         * @see org.cloudbus.cloudsim.container.schedulers.ContainerCloudletSchedulerDynamicWorkload#getCurrentRequestedMips
         */
        //System.out.println("VMallocation-5-3-2-B");
        return getContainerCloudletScheduler().getCurrentRequestedMips();//size大小也为1
    }
