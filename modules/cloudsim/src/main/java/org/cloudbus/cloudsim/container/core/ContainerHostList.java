...
public class ContainerHostList {
    ...
    public static <T extends ContainerHost> void sortByCpuUtilization(List<T> hostList) {
        System.out.println("VMmigration-12A-ContainerHostList.sortByCpuUtilizationDescending");
    ...
    public static <T extends ContainerHost> void sortByCpuUtilizationDescending(List<T> hostList) {
        ...
        System.out.println("VMmigration-12-ContainerHostList.sortByCpuUtilizationDescending");
    ...
    public static <T extends ContainerHost> void sortByUtilizationMipsDescending(List<T> hostList) {
        ...
        Collections.sort(hostList, Collections.reverseOrder(new Comparator<T>() {
            ...
            @Override
            public int compare(T a, T b) throws ClassCastException {
                Double aUtilizationMips = ((PowerContainerHost) a).getUtilizationMips();
                Double bUtilizationMips = ((PowerContainerHost) b).getUtilizationMips();
                return bUtilizationMips.compareTo(aUtilizationMips);
            }
        }));
    }

    public static <T extends ContainerHost> void sortByAvailableMipsDescending(List<T> hostList) {

        System.out.println("VMmigration-13-主机ContainerHostList.sortByAvailableMipsDescending");
        Collections.sort(hostList, new Comparator<T>() {

            @Override
            public int compare(T a, T b) throws ClassCastException {
                Double aAvailableMips = ((PowerContainerHost) a).getAvailableMips();
                Double bAvailableMips = ((PowerContainerHost) b).getAvailableMips();
