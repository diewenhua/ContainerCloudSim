...
public class MathUtil {
	...
	public static double median(final List<Double> list) {
		...
		//p为50，即求中位数
		//p the requested percentile (scaled from 0 - 100);  n:数据总量
		//pth percentile:  i=(p/100)n
		//i不是整数，取整，pth percentile即第i位上的值
		//i是整数，pth percentile为i和i+1两数的平均值
	 ...
	 * @return the IQR
	 */
	//Interquartile:四分点；Interquartile Range：四分位距
