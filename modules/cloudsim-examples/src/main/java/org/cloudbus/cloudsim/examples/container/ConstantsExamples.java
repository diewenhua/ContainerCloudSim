...
public class ConstantsExamples {
    ...
    public static final int CLOUDLET_LENGTH = 1000000;
    ...
    //public static final double[] VM_MIPS = new double[]{15000,20000,10000,18637};
    public static final double[] VM_MIPS = new double[]{500,563, 1500,500};
    ...
    //自己
    public static final float[] VM_RAM = new float[] {(float)4096, (float) 4096, (float) 8192, (float) 8192};//**MB*
    ...
    public static final int CONTAINER_TYPES = 4;
    //public static final int[] CONTAINER_MIPS = new int[]{4658, 9320, 18636};
    public static final int[] CONTAINER_MIPS = new int[]{465, 932, 763,201};
    public static final int[] CONTAINER_PES = new int[]{1, 1, 1,1};
    public static final int[] CONTAINER_RAM = new int[]{128, 256, 512,1024};
    ...
    public static final int[] HOST_MIPS = new int[]{37274, 1000, 1200};
...
//    public static final int NUMBER_CLOUDLETS = 350;
