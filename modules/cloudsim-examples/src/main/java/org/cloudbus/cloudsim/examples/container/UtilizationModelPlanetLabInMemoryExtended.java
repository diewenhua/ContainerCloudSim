...
public class UtilizationModelPlanetLabInMemoryExtended extends UtilizationModelPlanetLabInMemory {
    ...
    public double getUtilization(double inputTime) {
        //System.out.println("Containerallocation-2-0-5-UtilizationModelPlanetLabInMemoryExtended.getUtilization");
        double utilization;
...
//        Log.print(time);
        //System.out.println("Containerallocation-2-0-6-UtilizationModelPlanetLabInMemoryExtended.calUtilization");
