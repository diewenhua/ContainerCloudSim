...
public class Container_Example1 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //ContainerAllocationPolicy containerAllocationPolicy1=new
            /**
            ...
            PowerContainerSelectionPolicy containerSelectionPolicy = new PowerContainerSelectionPolicyMaximumUsage();
            ...
            double overUtilizationThreshold = 0.7;
            double underUtilizationThreshold = 0.2;
            /**
...
//                    hostSelectionPolicy, overUtilizationThreshold, underUtilizationThreshold);
            ...
            ContainerVmAllocationPolicy vmAllocationPolicy = new
                    PowerContainerVmAllocationPolicyMigrationStaticThresholdMC(hostList,vmSelectionPolicy,containerSelectionPolicy,hostSelectionPolicy,
                    overUtilizationThreshold,underUtilizationThreshold,4,ConstantsExamples.VM_PES,ConstantsExamples.VM_RAM,
                    ConstantsExamples.VM_BW,ConstantsExamples.VM_SIZE,ConstantsExamples.VM_MIPS);
            /**
            ...
            System.out.println("Mips:"+containerList.get(0).getMips()+containerList.get(0).getCurrentRequestedMips()+containerList.get(0).getCurrentRequestedTotalMips()+
                    containerList.get(0).getCurrentRequestedMaxMips()+containerList.get(0).getWorkloadTotalMips());
            ...
            //e.setContainerVmList(vmList);
            //e.setContainerList(containerList);
            ...
            //HelperEx.printResults(e, vmList,containerList ,lastClock, getExperimentName("ContainerCloudSimExample-1"), false, logAddress);
            HelperEx.printResultsNewWL(e, broker,lastClock, getExperimentName("ContainerCloudSimExample-1"), false, logAddress);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public static List<ContainerHost> createHostList(int hostsNumber) {
        ...
        for (int i = 0; i < hostsNumber; ++i) {
            ...
            hostList.add(new PowerContainerHostUtilizationHistory(IDs.pollId(ContainerHost.class),
                    ...
                    //自己
                    new ContainerVmBwProvisionerSimple(10000000L), 1000000L, peList,
